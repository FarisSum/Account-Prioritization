    ...
    <main className="mx-auto w-full max-w-3xl px-5 py-8">
      ...
      <section className="mt-6">
        <h2 className="flex items-center gap-1.5 text-sm font-semibold text-zinc-900 dark:text-zinc-100">
          <AgentIcon className="h-4 w-4 text-brand" />
          Recommended next action
        </h2>
        <p className="mt-1 text-xs text-zinc-500 dark:text-zinc-400">
          Generated by an agent that combines this account&rsquo;s CRM, product usage and recent Gong
          calls with fresh Tavily web research on{" "}
          <span className="font-mono">{account.domain.replace(/^https?:\/\//, "")}</span>, then asks
          Claude for the single highest-value move.
        </p>
        ...
        <div className="mt-4">
          {!configured ? (
            ...
            <div className="flex items-center gap-2 rounded-xl border border-brand/30 bg-brand-soft/40 p-4 text-sm text-zinc-700 dark:bg-brand-soft/20 dark:text-zinc-200">
              <span className="h-4 w-4 animate-spin rounded-full border-2 border-brand/40 border-t-brand" />
              Agent running… started {formatTimestamp(rec!.started_at)}. You can leave this page — it
